	...
	<div class="container">
		<div id="toolbar" class="select">
			<select class="form-control">
				<option value="">Exportar b�sico</option>
		...
		<table class="table table-bordered table-hover" id="mydatatable"
			...
			<thead class="thead-dark">
				<tr>
					...
					<th colspan="7" style="text-align: center">Forma��o</th>
				...
				<tr>
					...
					<th data-field="formacao"
						data-detail-formatter="formacaoDetailFormatter">Forma��o
						Acad�mica</th>
					<th colspan="auto" data-field="certificacao" data-visible="false"
						data-detail-formatter="certificacaoDetailFormatter">Certifica��es</th>
					...
					<th colspan="auto" data-field="restricoes" data-visible="false"
						data-detail-formatter="restricoesDetailFormatter">Restri��es
						Local</th>
					<th colspan="auto" data-field="beneficios" data-visible="false"
						data-detail-formatter="restricoesDetailFormatter">Benef�cios</th>
			...
			<tfoot>
				<tr>
					...
					<th colspan="auto" data-field="beneficios"
						data-detail-formatter="restricoesDetailFormatter">Benef�cios</th>
					<th colspan="auto" data-field="beneficios"
						data-detail-formatter="restricoesDetailFormatter">�rea</th>
